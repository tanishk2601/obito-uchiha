...
from Obito_Probot import telethn as bot
from Obito_Probot.modules.urluploader import download_file
from Obito_Probot.pyrogramee.pluginshelper import humanbytes, progress

DOWNLOADPATH = "./Obito_Probot/Downloads/"
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption="Uploaded By *Obito Uchiha Probot*",
            )
        except Exception as e:
            traceback.print_exc()
