...
import Obito_Probot.modules.fun_strings as fun_strings
from Obito_Probot import REDLIONS, SPRYZONS, dispatcher
from Obito_Probot.modules.disable import (
...
def slap(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        temp = random.choice(fun_strings.SLAP_obito_TEMPLATES)
