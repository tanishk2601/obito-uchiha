...
from Obito_Probot import pbot as app 
from Obito_Probot import arq
from Obito_Probot.services.keyboard import Ikb
from Obito_Probot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from Obito_Probot.services.tasks import _get_tasks_text, all_tasks, rm_task
from Obito_Probot.services.types import InlineQueryResultCachedDocument
from Obito_Probot.modules.info import get_chat_info, get_user_info
from Obito_Probot.modules.music import download_youtube_audio
from Obito_Probot.utils.functions import test_speedtest
from Obito_Probot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Obito_Probot"),
        InlineKeyboardButton(
